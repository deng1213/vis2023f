...
function _output_tree1(d3,output,invalidation)
{
   // 指定圖表的尺寸。
  const width = 1800;
  const height = 1050;
...
function _outupt_tree2(d3,output,drag,invalidation)
{
  // 指定圖表的尺寸。
  const width = 1800;
  const height = 1050;
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("output_tree1")).define("output_tree1", ["d3","output","invalidation"], _output_tree1);
  main.variable(observer()).define(["md"], _5);
  main.variable(observer("outupt_tree2")).define("outupt_tree2", ["d3","output","drag","invalidation"], _outupt_tree2);
