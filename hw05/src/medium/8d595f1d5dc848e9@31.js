...
function _output_tree1(d3,output,drag,invalidation)
{
  // 指定圖表的尺寸。
  const width = 1800;
  const height = 1050;
...
function _output_tree2(d3,output,drag,invalidation)
{
  // 指定圖表的尺寸。
  const width = 1800;
  const height = 1050;
...
function _output_tree3(d3,output,drag,invalidation)
{
  // 指定圖表的尺寸。
  const width = 1800;
  const height = 1050;
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("output_tree1")).define("output_tree1", ["d3","output","drag","invalidation"], _output_tree1);
  main.variable(observer("drag")).define("drag", ["d3"], _drag);
  main.variable(observer()).define(["md"], _6);
  main.variable(observer("output_tree2")).define("output_tree2", ["d3","output","drag","invalidation"], _output_tree2);
  main.variable(observer()).define(["md"], _8);
  main.variable(observer("output_tree3")).define("output_tree3", ["d3","output","drag","invalidation"], _output_tree3);
  return main;
}
