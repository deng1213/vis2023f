...
md`# Data Visualization - hw02 simple baseline
### by 112C53023`
)}
...
Plot.plot({ 
	...
	marks: [   
		...
		Plot.gridY({ interval: 1, stroke:  "white", strokeOpacity: 0.6 })
	]
})
)}
...
Inputs.form({
	mt:  Inputs.range([0, 100], {label: "margin_Top", step: 1}),
	mr:  Inputs.range([0, 100], {label: "margin_Right", step: 1}),
	mb:  Inputs.range([0, 100], {label: "margin_Bottom", step: 1}),
	ml:  Inputs.range([0, 100], {label: "margin_Left", step: 1}),
})
)}
